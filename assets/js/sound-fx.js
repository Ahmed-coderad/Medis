...
(function () {
  ...
  const SoundFX = {
    ...
    // "Bip-bip" singkat, satu nada diulang cepat — dipasangkan dengan
    // pulse-dot merah yang muncul saat peserta menandai alergi/masalah
    // pribadi sebagai "Ya". Berbeda dari alarm() (lebih panjang, berulang,
    // untuk pengingat) dan notify() (lebih lembut, untuk info netral) —
    // ini secara sengaja sedikit lebih tegas, seperti bip monitor vital.
    alert() {
      tone(784, 0, 0.09, 'square', 0.12);
      tone(784, 0.14, 0.11, 'square', 0.12);
    },
  };
