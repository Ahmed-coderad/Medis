  ...
  async function openDetail(id) {
    ...
    if (r.wants_to_explain === 'yes') {
      ...
      try {
        ...
        const box = document.getElementById('wellbeingNoteBox');
        if (box) {
          box.innerHTML = `<p class="contact-note">🔒 Cerita ini bersifat rahasia dan hanya dapat dilihat oleh ${escapeHtml(r.target_staff_name || 'guru/staf yang dipilih peserta')}.</p>`;
        }
      }
    }
  }
